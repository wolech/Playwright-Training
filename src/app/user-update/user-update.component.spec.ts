...
const passworderrorMessage = await page.locator('text=Password is required.');
...
const firstnameerrorMessage = await page.locator('text=First Name is required.');
...
const lastnameerrorMessage = await page.locator('text=Last Name is required.');
...
const phoneErrorMessage = await page.locator('text=Phone Number is required');
